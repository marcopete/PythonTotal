    ...
    while intentos < 8:
        ...
        if intento < 1 or intento > 100:
            ...
            if intento == numero_secreto:
                ...
                print(f"Tu respuesta es incorrecta. Has elegido un número menor al número secreto. Intento {intentos}")
            else:
                print(f"Tu respuesta es incorrecta. Has elegido un número mayor al número secreto. Intento {intentos}")
